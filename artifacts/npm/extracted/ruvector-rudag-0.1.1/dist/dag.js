...
async function initWasm() {
    ...
    wasmLoadPromise = (async () => {
        try {
            ...
            const mod = await import('../pkg/ruvector_dag_wasm.js');
            ...
            try {
                ...
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                const mod = await import('../pkg-node/ruvector_dag_wasm.js');
                wasmModule = mod;
                return wasmModule;
            }
            catch (e) {
