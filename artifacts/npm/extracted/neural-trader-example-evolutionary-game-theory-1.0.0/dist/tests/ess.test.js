...
import { PRISONERS_DILEMMA, HAWK_DOVE, STAG_HUNT, ROCK_PAPER_SCISSORS, } from '../src/games.js';
...
describe('ESS Properties', () => {
    ...
    it('should have correct stability properties', () => {
        ...
        if (result.isStable) {
            ...
            const hasPositiveEigenvalue = result.eigenvalues.some((lambda) => lambda > 1e-4);
...
//# sourceMappingURL=ess.test.js.map