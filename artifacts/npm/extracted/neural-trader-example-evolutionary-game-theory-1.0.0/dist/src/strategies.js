 ...
 */
export const TIT_FOR_TAT = {
    id: 'tit-for-tat',
    name: 'Tit-for-Tat',
    description: 'Cooperates first, then copies opponent',
    cooperationRate: 0.9,
    memory: 1,
    play: (history, opponentHistory) => {
 ...
 */
export function createGenerousTitForTat(forgivenessRate = 0.1) {
    return {
 ...
 */
export const CLASSIC_STRATEGIES = [
    ALWAYS_COOPERATE,
    ALWAYS_DEFECT,
    TIT_FOR_TAT,
    TIT_FOR_TWO_TATS,
 ...
 */
export function createLearningStrategy(id, name, weights) {
    return {
        id,
        name,
