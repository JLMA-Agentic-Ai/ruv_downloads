 ...
 */
export function createHawkDoveGame(resourceValue = 4, fightCost = 6) {
    return {
        id: 'hawk-dove',
        name: 'Hawk-Dove Game',
 ...
 */
export function createPublicGoodsGame(multiplicationFactor = 1.5) {
 ...
 */
export function calculatePayoff(game, strategy, population) {
    let payoff = 0;
 ...
 */
export function calculateFitnessValues(game, population) {
    const fitness = [];
 ...
 */
export function findPureNashEquilibria(game) {
    const equilibria = [];
    for (let i = 0; i < game.numStrategies; i++) {
