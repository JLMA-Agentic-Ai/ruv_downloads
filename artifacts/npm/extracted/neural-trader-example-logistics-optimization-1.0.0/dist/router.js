...
class VRPRouter {
     ...
     */
    async solveSimulatedAnnealing(config) {
        const startTime = Date.now();
     ...
     */
    constructAntSolution(pheromones) {
     ...
     */
    updatePheromones(pheromones, solutions, evaporationRate) {
