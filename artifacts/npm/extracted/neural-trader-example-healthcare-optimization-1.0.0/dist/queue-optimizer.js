...
export class QueueOptimizer {
    ...
    addPatient(patient) {
        ...
        const insertIndex = this.state.waitingPatients.findIndex(p => p.acuity > patient.acuity);
        if (insertIndex === -1) {
     ...
     */
    completeService(patientId, resourceId) {
    ...
    optimizeResources(objective) {
        ...
        for (const resource of this.state.resources) {
            ...
            const optimalCapacity = this.calculateOptimalCapacity(resource, queueLength, objective);
     ...
     */
    calculateOptimalCapacity(resource, queueLength, objective) {
...
//# sourceMappingURL=queue-optimizer.js.map