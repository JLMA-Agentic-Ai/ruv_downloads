...
exports.SupplyChainSystem = exports.SwarmPolicyOptimizer = exports.InventoryOptimizer = exports.DemandForecaster = void 0;
exports.createSupplyChainSystem = createSupplyChainSystem;
exports.retailExample = retailExample;
exports.manufacturingExample = manufacturingExample;
exports.ecommerceExample = ecommerceExample;
// Core exports
var demand_forecaster_1 = require("./demand-forecaster");
Object.defineProperty(exports, "DemandForecaster", { enumerable: true, get: function () { return demand_forecaster_1.DemandForecaster; } });
var inventory_optimizer_1 = require("./inventory-optimizer");
Object.defineProperty(exports, "InventoryOptimizer", { enumerable: true, get: function () { return inventory_optimizer_1.InventoryOptimizer; } });
var swarm_policy_1 = require("./swarm-policy");
Object.defineProperty(exports, "SwarmPolicyOptimizer", { enumerable: true, get: function () { return swarm_policy_1.SwarmPolicyOptimizer; } });
/**
 * Complete supply chain optimization system
 */
const demand_forecaster_2 = require("./demand-forecaster");
const inventory_optimizer_2 = require("./inventory-optimizer");
const swarm_policy_2 = require("./swarm-policy");
class SupplyChainSystem {
    ...
    constructor(config) {
        ...
        this.forecaster = new demand_forecaster_2.DemandForecaster(config.forecast);
        this.optimizer = new inventory_optimizer_2.InventoryOptimizer(this.forecaster, config.optimizer);
        this.swarmOptimizer = new swarm_policy_2.SwarmPolicyOptimizer(this.forecaster, this.optimizer, config.swarm);
    }
    /**
     * Initialize supply chain network
     */
    addInventoryNode(node) {
    ...
    async optimize(productId, currentFeatures) {
        ...
        this.optimizer = new inventory_optimizer_2.InventoryOptimizer(this.forecaster, {
            ...this.config.optimizer,
            safetyFactor: bestPolicy.safetyFactor,
        });
        // Optimize network with best policy
        const networkOptimization = await this.optimizer.optimizeNetwork(productId, currentFeatures);
        return {
            swarmResult,
            networkOptimization,
            bestPolicy,
     ...
     */
    async getRecommendations(productId, currentFeatures) {
        // Get demand forecast
     ...
     */
    generateReason(result, forecast) {
...
exports.SupplyChainSystem = SupplyChainSystem;
/**
 * Factory function for easy setup
 */
function createSupplyChainSystem(config = {}) {
    const defaultConfig = {
        forecast: {
            alpha: 0.1,
            horizons: [1, 7, 14, 30],
 ...
 */
async function manufacturingExample() {
    const system = createSupplyChainSystem({
        optimizer: {
