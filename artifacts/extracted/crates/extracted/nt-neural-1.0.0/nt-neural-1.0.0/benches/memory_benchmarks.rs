...
use nt_neural::utils::{
    ...
    preprocessing::{difference, normalize, robust_scale},
    preprocessing_optimized::{
        difference_optimized, normalize_in_place, normalize_pooled, robust_scale_optimized,
        WindowPreprocessor,
    },
};
...
fn bench_normalize_variants(c: &mut Criterion) {
    ...
    for size in [100, 1000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::new("allocating", size), size, |b, _| {
            b.iter(|| {
