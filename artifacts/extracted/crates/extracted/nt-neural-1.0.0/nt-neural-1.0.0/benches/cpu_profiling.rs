...
fn profile_memory_operations(c: &mut Criterion) {
    ...
    for size in [1000, 5000, 10000] {
        ...
        group.bench_with_input(BenchmarkId::new("tensor_add", size), &size, |b, _| {
            b.iter(|| {
        ...
        group.bench_with_input(BenchmarkId::new("tensor_matmul", size), &size, |b, _| {
            b.iter(|| {
...
fn profile_cache_operations(c: &mut Criterion) {
    ...
    for size in [1000, 10000, 100000] {
        ...
        group.bench_with_input(BenchmarkId::new("strided_sum", size), &size, |b, _| {
            b.iter(|| {
