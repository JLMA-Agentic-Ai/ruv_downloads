...
use nt_neural::utils::synthetic::{create_sequences, train_val_split, trend_seasonality};
...
impl SimpleTCNWeights {
    fn new(kernel_size: usize, hidden_size: usize, output_size: usize) -> Self {
        ...
        Self {
            kernel1: Array1::from_shape_fn(kernel_size, |_| rng.gen_range(-init_scale..init_scale)),
            kernel2: Array1::from_shape_fn(kernel_size, |_| rng.gen_range(-init_scale..init_scale)),
