...
pub use rlm::{
    ...
    RecursiveConfig, RecursiveConfigBuilder, AggregationStrategy, ConfigValidationError, DecompositionConfig,
    // Controller types
    RlmController, RlmStats, RlmStatsSnapshot, QueryResult,
    MemoryEntry as RlmMemoryEntry, MemoryMetadata as RlmMemoryEntryMetadata,
    SourceAttribution, ControllerTokenUsage,
    // Decomposer types
    QueryDecomposer, DecompositionResult, DecomposerStats, DecomposerStatsSnapshot,
    DecomposerStrategy, DecomposerSubQuery, QueryType,
    // Synthesizer types
    AnswerSynthesizer, SynthesisResult,
    // Environment types
    RlmEnvironment, NativeEnvironment, EnvironmentConfig, EnvironmentType,
    // Memory types
    RlmMemory, MemoryConfig as RlmMemoryConfig, MemorySearchResult as RlmMemorySearchResult,
    MemoryStoreEntry, MemoryStoreMetadata,
    // Trait types
    LlmBackendTrait, MemoryStore as RlmMemoryStore,
    TraitsGenerationParams, TraitsGenerationOutput, TraitsFinishReason,
    TraitsMemorySpan, TraitsMemoryMetadata, TraitsQueryContext, TraitsQueryDecomposition,
    TraitsRlmAnswer, TraitsSubAnswer, TraitsSubQuery,
    TraitsDecompositionStrategy, TraitsTokenUsage,
    RlmModelInfo,
    // Type module types
    MemoryId, MemorySpan, QueryId, AnswerId, Query, QueryConstraints, QueryContext,
    QueryDecomposition, DecompositionStrategy, SubQuery, SubAnswer, RlmAnswer,
    GenerationParams as RlmGenerationParams, GenerationOutput as RlmGenerationOutput,
    FinishReason as RlmFinishReason, TokenUsage as RlmTokenUsage,
    // RuvLTRA backend types
    RuvLtraRlmBackend, RuvLtraRlmConfig, RuvLtraEnvironment, RuvLtraEnvConfig,
    KvCache as RlmKvCache, KvCacheEntry as RlmKvCacheEntry, KvCacheStats as RlmKvCacheStats,
    EmbeddingPooling, RuvLtraBackendStats, RuvLtraMemoryStore,
};

// WASM RLM exports (wasm32 only with rlm-wasm feature)
#[cfg(all(target_arch = "wasm32", feature = "rlm-wasm"))]
pub use rlm::{WasmRlmController, WasmEnvironment};
