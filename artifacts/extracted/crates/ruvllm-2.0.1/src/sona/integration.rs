...
impl std::fmt::Debug for SonaIntegration {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("SonaIntegration")
            ...
            .field("total_trajectories", &self.total_trajectories.load(std::sync::atomic::Ordering::Relaxed))
            .field("instant_updates", &self.instant_updates.load(std::sync::atomic::Ordering::Relaxed))
            .field("background_updates", &self.background_updates.load(std::sync::atomic::Ordering::Relaxed))
            .field("deep_updates", &self.deep_updates.load(std::sync::atomic::Ordering::Relaxed))
            .finish()
    }
}
