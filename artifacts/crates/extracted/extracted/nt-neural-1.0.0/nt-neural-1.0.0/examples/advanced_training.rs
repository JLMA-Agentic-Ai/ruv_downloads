...
use nt_neural::{
    ModelConfig, NHITSConfig, NHITSTrainer, NHITSTrainingConfig, OptimizerConfig, OptimizerType,
    TrainingConfig,
};
use polars::prelude::*;
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!(
        "  Model hidden size: {}",
        config.model_config.base.hidden_size
    );
    ...
    tracing::info!("  Validation loss: {:.6}", metrics.val_loss.unwrap_or(0.0));
