...
use crate::{
    OrderRequest, OrderResponse, OrderSide, OrderStatus, OrderType, OrderUpdate, Symbol,
    TimeInForce,
};
...
impl BrokerClient for AlpacaBroker {
    async fn get_account(&self) -> Result<Account, BrokerError> {
        ...
        Ok(Account {
            ...
            portfolio_value: Decimal::from_str_exact(&account.portfolio_value).unwrap_or_default(),
    ...
    async fn get_positions(&self) -> Result<Vec<Position>, BrokerError> {
        ...
        let positions: Vec<AlpacaPosition> = self
            .request(Method::GET, "/v2/positions", None::<()>)
            .await?;
        ...
        Ok(positions
            ...
            .map(|pos| Position {
                ...
                avg_entry_price: Decimal::from_str_exact(&pos.avg_entry_price).unwrap_or_default(),
