...
describe('SwarmEvolution', () => {
    ...
    describe('Genetic Operations', () => {
        ...
        it('should preserve elites', async () => {
            ...
            expect(result2.bestFitness).toBeGreaterThanOrEqual(result1.bestFitness - 0.5); // Allow some variance
        });
    });
    describe('Evolution Process', () => {
        ...
        it('should improve fitness over time', async () => {
            ...
            expect(result2.bestFitness).toBeGreaterThanOrEqual(result1.bestFitness - 1.0);
        });
...
//# sourceMappingURL=swarm-evolution.test.js.map