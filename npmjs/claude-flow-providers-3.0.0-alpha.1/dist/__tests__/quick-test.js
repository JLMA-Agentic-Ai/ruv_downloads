...
import { AnthropicProvider, OpenAIProvider, GoogleProvider, OllamaProvider, RuVectorProvider, createProviderManager, } from '../index.js';
import { consoleLogger } from '../base-provider.js';
const TEST_PROMPT = 'Say "Hello from Claude Flow V3!" Be brief.';
const createTestRequest = (model) => ({
