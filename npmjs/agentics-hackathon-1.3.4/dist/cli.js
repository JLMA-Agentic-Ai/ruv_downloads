...
program
    ...
    logger.box(`Join the Agentics Foundation Discord community!\n\n` +
        `${chalk.bold('Benefits:')}\n` +
        `  • Team formation & networking\n` +
        `  • Technical support & mentorship\n` +
        `  • Announcements & updates\n` +
        `  • Share your progress\n\n` +
        chalk.cyan.bold.underline(DISCORD_URL), 'Discord Community');
    logger.newline();
...
program
    ...
    logger.box(`Visit the official hackathon website:\n\n` +
        chalk.cyan.bold.underline(WEBSITE_URL), 'Hackathon Website');
});
