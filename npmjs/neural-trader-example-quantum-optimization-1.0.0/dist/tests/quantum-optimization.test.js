...
import { VQESolver, QuantumOptimizer, QuantumClassicalComparison, createIsingHamiltonian, QUBOFormulator, solveMaxCut, solveQUBO, exploreCircuits } from '../src/index.js';
...
describe('VQE (Variational Quantum Eigensolver)', () => {
    test('should find ground state of simple Hamiltonian', async () => {
        ...
        const hamiltonian = createIsingHamiltonian([[0, 1], [1, 0]], // ZZ coupling
        [-0.5, -0.5] // Z fields
        );
    ...
    test('should compare different ansatz types', async () => {
        const hamiltonian = createIsingHamiltonian([[0, 1, 0], [1, 0, 1], [0, 1, 0]], [-0.3, -0.3, -0.3]);
    ...
    test('should optimize with Adam optimizer', async () => {
        const hamiltonian = createIsingHamiltonian([[0, 1], [1, 0]], [-1, -1]);
        const solver = new VQESolver({
            numQubits: 2,
            ansatzType: 'hardware-efficient',
            ansatzDepth: 2,
...
describe('Quantum Annealing', () => {
    ...
    test('should solve constraint satisfaction', async () => {
        const qubo = QUBOFormulator.constraintSatisfactionToQUBO(4, [
...
describe('Unified Quantum Optimizer', () => {
    ...
    test('should optimize portfolio', async () => {
        ...
        const result = await QuantumOptimizer.optimizePortfolio(returns, covariance, 2, 1.5);
    ...
    test('should solve constraint satisfaction', async () => {
        const result = await QuantumOptimizer.solveConstraintSatisfaction(3, [
...
describe('Edge Cases and Error Handling', () => {
    ...
    test('should handle empty Hamiltonian', async () => {
        const hamiltonian = createIsingHamiltonian([[0]], [0]);
        const solver = new VQESolver({
            numQubits: 1,
            ansatzType: 'hardware-efficient',
            ansatzDepth: 1,
...
//# sourceMappingURL=quantum-optimization.test.js.map