 ...
 */
// QAOA exports
export { QAOAOptimizer, createMaxCutProblem, solveMaxCut } from './qaoa.js';
// VQE exports
export { VQESolver, createIsingHamiltonian } from './vqe.js';
// Quantum Annealing exports
export { QuantumAnnealer, QUBOFormulator, solveQUBO, solveMaxCutAnnealing, solveTSPAnnealing } from './quantum-annealing.js';
// Swarm Circuit Exploration exports
export { SwarmCircuitExplorer, exploreCircuits } from './swarm-circuits.js';
/**
...
export class QuantumOptimizer {
     ...
     */
    static async solveMaxCut(edges, method = 'auto') {
     ...
     */
    static async solveTSP(distanceMatrix) {
     ...
     */
    static async findGroundState(hamiltonian, ansatzType = 'hardware-efficient') {
     ...
     */
    static async optimizePortfolio(returns, covarianceMatrix, budget, riskAversion = 1.0) {
        const { QUBOFormulator, solveQUBO } = await import('./quantum-annealing.js');
        const qubo = QUBOFormulator.portfolioToQUBO(returns, covarianceMatrix, budget, riskAversion);
     ...
     */
    static async solveConstraintSatisfaction(numVars, constraints) {
        const { QUBOFormulator, solveQUBO } = await import('./quantum-annealing.js');
...
export class QuantumClassicalComparison {
     ...
     */
    static async compareMaxCut(edges) {
        // Quantum solution
     ...
     */
    static evaluateMaxCut(edges, solution) {
        let energy = 0;
...
export const examples = {
    ...
    async portfolio() {
        ...
        const result = await QuantumOptimizer.optimizePortfolio(returns, covariance, 2, // Budget: invest in 2 assets
        1.5 // Risk aversion
        );
