...
export type AgentType = 'coordinator' | 'researcher' | 'coder' | 'analyst' | 'architect' | 'tester' | 'reviewer' | 'optimizer' | 'documenter' | 'monitor' | 'specialist' | 'queen' | 'worker';
...
export type TaskType = 'research' | 'analysis' | 'coding' | 'testing' | 'review' | 'documentation' | 'coordination' | 'consensus' | 'custom';
...
export type MessageType = 'task_assign' | 'task_complete' | 'task_fail' | 'heartbeat' | 'status_update' | 'consensus_propose' | 'consensus_vote' | 'consensus_commit' | 'topology_update' | 'agent_join' | 'agent_leave' | 'broadcast' | 'direct';
...
export type SwarmStatus = 'initializing' | 'running' | 'paused' | 'recovering' | 'shutting_down' | 'stopped' | 'failed';
...
export type SwarmEventType = 'swarm.initialized' | 'swarm.started' | 'swarm.paused' | 'swarm.resumed' | 'swarm.stopped' | 'swarm.failed' | 'agent.joined' | 'agent.left' | 'agent.status_changed' | 'agent.heartbeat' | 'agent.domain_assigned' | 'task.created' | 'task.assigned' | 'task.started' | 'task.completed' | 'task.failed' | 'task.queued' | 'topology.updated' | 'topology.rebalanced' | 'consensus.proposed' | 'consensus.achieved' | 'consensus.failed' | 'message.sent' | 'message.received' | 'parallel.execution.completed' | 'hierarchy.spawned';
...
export declare const SWARM_CONSTANTS: {
    ...
    readonly COORDINATION_LATENCY_TARGET_MS: 100;
    readonly MESSAGES_PER_SECOND_TARGET: 1000;
};
