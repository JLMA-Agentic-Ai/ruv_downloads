 ...
 */
import { agentSpawnedEvent, agentStatusChangedEvent, agentErrorEvent } from '../shared/events';
// =============================================================================
...
export class AgentRegistry {
    ...
    getAgentsByCapability(taskType) {
        return Array.from(this.definitions.values()).filter(d => d.capabilities.some(c => c.supportedTaskTypes.includes(taskType)));
    }
    // ==========================================================================
    // Health Management
    // ==========================================================================
        ...
        for (const [agentId, healthStatus] of this.healthChecks) {
            ...
            if (timeSinceHeartbeat > this.healthCheckInterval) {
                ...
                if (healthStatus.consecutiveMisses >= this.maxMissedHeartbeats) {
                    ...
                    this.eventBus.emitSync(agentErrorEvent(agentId, new Error(`Agent ${agentId} missed ${healthStatus.consecutiveMisses} heartbeats`)));
                }
            }
        }
    }
...
// Factory Function
// =============================================================================
export function createAgentRegistry(eventBus) {
