...
export { V2CompatibilityValidator, generateCompatibilityReport, } from './compatibility-validator.js';
// V2 definitions
export { V2_CLI_COMMANDS, V2_MCP_TOOLS, V2_HOOKS, V2_API_INTERFACES, } from './compatibility-validator.js';
