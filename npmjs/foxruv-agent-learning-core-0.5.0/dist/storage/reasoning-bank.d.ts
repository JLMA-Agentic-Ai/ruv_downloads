...
export declare class ReasoningBankManager {
     ...
     */
    getCausalChain(decisionId: string, depth?: number): Promise<import("./agentdb-integration").CausalDecision[]>;
    /**
     ...
     */
    getRecentReflexions(limit?: number): Promise<import("./agentdb-integration").ReflexionEntry[]>;
    /**
     ...
     */
    getLearnedSkill(name: string): Promise<import("./agentdb-integration").LearnedSkill | null>;
    /**
     * List all learned skills
     */
    listLearnedSkills(): Promise<import("./agentdb-integration").LearnedSkill[]>;
    /**
