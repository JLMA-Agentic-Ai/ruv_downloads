 ...
 * @version 1.0.0
 */
import { AgentDBSingleton } from './agentdb-singleton';
/**
...
export class AgentDBManager {
    ...
    constructor(config = {}) {
        ...
        // Initialize database asynchronously (methods have null guards)
    ...
    close() {
        if (this.db) {
            try {
                ...
                console.warn('⚠ AgentDBManager: Failed to close database:', error);
            }
            finally {
                this.db = null;
            }
