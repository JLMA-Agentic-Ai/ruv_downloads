/**
 * IRIS Prime - Intelligent Reflexive Intelligence System
 *
 ...
 *
 * IRIS Prime is the executive function that ties together:
...
import { createGlobalMetrics, createPromptRegistry, createReflexionMonitor, createConsensusLineageTracker, createPatternDiscovery, trainExpertsInParallel } from '../index';
// Supabase integration for durable persistence
import { logTelemetry, storeExpertSignature, recordSignatureUpgrade, detectDrift, } from '../supabase';
/**
...
export class IrisPrime {
    ...
    constructor(config = {}) {
        ...
        console.log('🤖 IRIS Prime initialized');
    }
    // ============================================================================
                ...
                try {
                    ...
                    {}, // Placeholder signature - actual signature should be loaded from signatureId
                    {
                        ...
                        metadata: {
                            ...
                            promotionReason: 'Auto-promotion via IRIS Prime',
        ...
        for (const alert of retrainingNeeded) {
            ...
            if (results[0].success) {
                ...
                try {
                    ...
                    await storeExpertSignature(alert.expertId, newVersion, 'Retrained prompt via IRIS Prime auto-retraining', {}, // Placeholder signature - actual signature should be extracted from training results
                    {
                        performanceMetrics: {
    ...
    close() {
        ...
        console.log('🔒 IRIS Prime shutdown complete');
    }
}
/**
 * Create IRIS Prime instance
 */
