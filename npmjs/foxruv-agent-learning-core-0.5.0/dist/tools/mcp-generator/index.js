...
import { ${className} } from './servers/${serverInfo.name}';
...
This wrapper was auto-generated by @foxruv/agent-learning-core MCP Wrapper Generator.
...
console.log(result);`;
    ...
    createContext(serverInfo, target) {
        return {
            ...
            packageName: '@foxruv/agent-learning-core',
        };
    }
}
/**
