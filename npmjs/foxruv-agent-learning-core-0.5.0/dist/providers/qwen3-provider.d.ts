...
export declare class Qwen3Provider {
    ...
    constructor(endpoint?: string, maxConcurrency?: number);
    /**
     ...
     */
    predict(signature: Signature, input: Record<string, any>, customInstructions?: string, temperature?: number, maxTokens?: number): Promise<Record<string, any>>;
    /**
