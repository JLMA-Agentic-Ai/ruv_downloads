 ...
 * ```
 */
export declare function logTelemetry(data: TelemetryData): Promise<ModelRunLog>;
/**
 ...
 * ```
 */
export declare function getRecentLogs(expertId?: string, limit?: number): Promise<ModelRunLog[]>;
/**
