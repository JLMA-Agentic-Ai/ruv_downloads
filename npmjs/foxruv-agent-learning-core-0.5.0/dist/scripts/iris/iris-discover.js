...
import { initSupabaseFromEnv, isSupabaseInitialized, saveReflexion } from '../../supabase';
...
class CodeInstrumenter {
    async instrumentExpert(expert) {
        ...
        if (expert.language === 'typescript' || expert.language === 'javascript') {
            // Add import
            change.imports.push(`import { logTelemetry } from '@foxruv/agent-learning-core/supabase'`);
