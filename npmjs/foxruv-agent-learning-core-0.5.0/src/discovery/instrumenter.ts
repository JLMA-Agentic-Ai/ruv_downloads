 ...
 * - Sending telemetry data to hardcoded Iris Prime backend
 *
...
export class CodeInstrumenter {
  ...
  constructor(options: InstrumentationOptions = {}) {
    this.options = {
      ...
      telemetryImportPath: options.telemetryImportPath ?? '@foxruv/agent-learning-core',
    };
  }
 ...
 * Automatically sends to Iris Prime backend with zero configuration
 */
