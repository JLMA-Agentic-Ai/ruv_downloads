/**
 * Daily Digest Builder for IRIS Prime
 *
 * Builds comprehensive daily summaries from IRIS Prime evaluations
...
import { irisPrime, type IrisPrime, type CrossProjectReport } from '../orchestrators/iris-prime'
import type { DailyDigest } from './types'
import type { IrisReport } from '../orchestrators/iris-prime'

/**
 * Build daily digest from IRIS Prime evaluations
 *
 * @param projects - Optional list of project IDs to include
 * @param iris - Optional IRIS Prime instance to reuse (avoids creating new instance)
