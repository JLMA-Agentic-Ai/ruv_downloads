...
class MultiObjectiveOptimizer {
    ...
    mutationRate = 0.1;
    generation = 0;
    constructor(populationSize = 100, generations = 50) {
    ...
    createNewPopulation() {
        ...
        while (newPopulation.length + this.paretoFronts[frontIndex].individuals.length <= this.populationSize) {
            ...
            frontIndex++;
            if (frontIndex >= this.paretoFronts.length)
                break;
        }
    ...
    printProgress() {
        ...
        const best = {
            performance: front0.individuals.reduce((a, b) => a.objectives.performance > b.objectives.performance ? a : b),
            efficiency: front0.individuals.reduce((a, b) => a.objectives.efficiency > b.objectives.efficiency ? a : b),
            reliability: front0.individuals.reduce((a, b) => a.objectives.reliability > b.objectives.reliability ? a : b),
        };
...
//# sourceMappingURL=advanced-multi-objective-optimizer.js.map