...
describe('Adaptive Risk Manager', () => {
    ...
    describe('Position Sizing', () => {
        it('should calculate adaptive position sizes', async () => {
            ...
            const adjustedWeights = await riskManager.calculatePositionSizes(baseWeights, marketConditions, 0.95);
    ...
    describe('Rebalancing', () => {
        it('should trigger rebalancing when deviation exceeds threshold', async () => {
            ...
            const shouldRebalance = await riskManager.shouldRebalance(currentWeights, targetWeights, 0.04);
        ...
        it('should not trigger rebalancing for small deviations', async () => {
            ...
            const targetWeights = [0.30, 0.40, 0.30];
            const shouldRebalance = await riskManager.shouldRebalance(currentWeights, targetWeights, 0.05);
            expect(shouldRebalance).toBe(false);
        });
    });
});
//# sourceMappingURL=self-learning.test.js.map