...
import { PortfolioOptimizationSwarm, ParallelPortfolioExplorer, } from '../src/benchmark-swarm.js';
describe('Portfolio Optimization Swarm', () => {
    ...
    describe('Constraint Exploration', () => {
        it('should explore constraint space', async () => {
            const insights = await swarm.exploreConstraints(config, {
                minWeight: [0.05, 0.20],
                maxWeight: [0.40, 0.60],
    ...
    describe('Market Regime Comparison', () => {
        ...
        it('should adapt strategies to market conditions', async () => {
            ...
            expect(bullResult.bestResult.result.expectedReturn).toBeGreaterThan(bearResult.bestResult.result.expectedReturn);
        });
    });
...
//# sourceMappingURL=benchmark-swarm.test.js.map