...
declare const DataTypeSchema: z.ZodEnum<["timeseries", "events", "structured", "text", "json", "csv"]>;
...
declare const SynthConfigSchema: z.ZodObject<{
    ...
    cacheStrategy: "memory" | "none" | "disk";
    cacheTTL: number;
    maxRetries: number;
    timeout: number;
    streaming: boolean;
    ...
    apiKey?: string | undefined;
    model?: string | undefined;
    cacheStrategy?: "memory" | "none" | "disk" | undefined;
