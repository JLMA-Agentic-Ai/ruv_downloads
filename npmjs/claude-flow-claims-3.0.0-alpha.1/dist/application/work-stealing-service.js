...
exports.WorkStealingService = exports.InMemoryWorkStealingEventBus = void 0;
exports.createWorkStealingService = createWorkStealingService;
 ...
 */
class InMemoryWorkStealingEventBus {
    handlers = new Map();
    history = [];
    maxHistorySize;
    constructor(options = {}) {
...
exports.InMemoryWorkStealingEventBus = InMemoryWorkStealingEventBus;
// =============================================================================
...
class WorkStealingService {
    ...
    constructor(repository, eventBus, config = {}) {
        ...
        this.config = { ...types_js_1.DEFAULT_WORK_STEALING_CONFIG, ...config };
    }
    // ===========================================================================
    // Mark Stealable
    // ===========================================================================
...
exports.WorkStealingService = WorkStealingService;
// =============================================================================
// Factory Function
// =============================================================================
/**
 ...
 */
function createWorkStealingService(repository, config, eventBus) {
