 ...
 */
export type SONALearningMode = 'real-time' | 'balanced' | 'research' | 'edge' | 'batch';
 ...
 */
export type AttentionMechanism = 'flash' | 'multi-head' | 'linear' | 'hyperbolic' | 'moe' | 'local' | 'global' | 'sparse';
...
export type IntegrationEventType = 'initialized' | 'component-connected' | 'component-disconnected' | 'pattern-stored' | 'pattern-retrieved' | 'trajectory-started' | 'trajectory-completed' | 'learning-cycle-completed' | 'attention-computed' | 'search-performed' | 'error' | 'warning' | 'health-check';
export declare class IntegrationError extends Error {
    readonly code: IntegrationErrorCode;
    readonly component: string;
    readonly cause?: Error | undefined;
    constructor(message: string, code: IntegrationErrorCode, component: string, cause?: Error | undefined);
}
export type IntegrationErrorCode = 'INITIALIZATION_FAILED' | 'COMPONENT_UNAVAILABLE' | 'VERSION_MISMATCH' | 'FEATURE_DISABLED' | 'RUNTIME_ERROR' | 'TIMEOUT' | 'CONFIGURATION_INVALID' | 'MEMORY_EXHAUSTED' | 'SEARCH_FAILED' | 'LEARNING_FAILED';
export declare const DEFAULT_SONA_CONFIG: SONAConfiguration;
export declare const DEFAULT_ATTENTION_CONFIG: AttentionConfiguration;
export declare const DEFAULT_AGENTDB_CONFIG: AgentDBConfiguration;
