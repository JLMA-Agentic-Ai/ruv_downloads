...
export async function benchmark() {
    ...
    let score = 0;
    if (results.sona && results.sona.latencyMs < 1)
        score += 50;
    else if (results.sona && results.sona.latencyMs < 5)
        score += 30;
    else if (results.sona)
        score += 10;
    if (results.attention && results.attention.latencyMs < 1)
        score += 50;
    else if (results.attention && results.attention.latencyMs < 5)
        score += 30;
    else if (results.attention)
        score += 10;
    if (score >= 90)
        ...
        results.overall.grade = 'D';
    else
        results.overall.grade = 'F';
