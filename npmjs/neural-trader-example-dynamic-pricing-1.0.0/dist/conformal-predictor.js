...
exports.ConformalPredictor = void 0;
class ConformalPredictor {
     ...
     */
    adaptivePredict(pointPrediction, recentPredictions, recentActuals) {
     ...
     */
    multiStepPredict(pointPredictions, horizon) {
     ...
     */
    isValid(prediction, actual) {
        return actual >= prediction.lower && actual <= prediction.upper;
    }
    /**
     * Calculate empirical coverage
     */
    calculateCoverage(predictions, actuals) {
...
exports.ConformalPredictor = ConformalPredictor;
