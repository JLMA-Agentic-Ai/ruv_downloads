...
var EnhancedPatternEngine = class {
  constructor() {
    ...
    this.gnn = new gnn.RuvectorLayer(this.dimension, 512, 4, 0.1);
    this.compressor = new gnn.TensorCompress();
  }
  /**
...
exports.CompressionInfo = CompressionInfo;
exports.EnhancedPatternEngine = EnhancedPatternEngine;
exports.HNSWPresets = HNSWPresets;
