 ...
 */
export declare class AntiHallucinationVerifier {
     ...
     */
    verifyClaims(claims: string[], citations: CitationSignature[]): Promise<{
        verified: number;
        total: number;
        confidence: number;
     ...
     */
    extractAndVerifyFacts(text: string, citations: CitationSignature[]): Promise<any>;
    /**
     * Verify citations (compatibility method)
     */
    verifyCitations(citations: CitationSignature[]): Promise<any>;
    /**
     * Sign search result (compatibility method)
     */
    signSearchResult(searchResult: any): Promise<any>;
}
