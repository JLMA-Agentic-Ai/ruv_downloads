...
use nt_neural::storage::{AgentDbConfig, AgentDbStorage, ModelMetadata};
...
async fn main() -> anyhow::Result<()> {
    ...
    println!(
        "📦 Initializing AgentDB storage at: {}",
    ...
    let metadata = ModelMetadata {
        ...
        description: Some(
            "Neural network model for predicting Bitcoin prices using NHITS architecture"
                .to_string(),
        ),
        tags: vec![
            "crypto".to_string(),
